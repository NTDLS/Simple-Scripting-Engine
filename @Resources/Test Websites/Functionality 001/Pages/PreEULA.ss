<h2>Pre-Release Software License</h2>
<hr />
...
<P>
<B>TEST AND REPORT</B><BR>
  <BlockQuote>
  Tester agrees to report to NetworkDLS any flaws, errors, bugs or other problems with the Product.
		Such reports are made by logging into the <a href="TesterLogin.asp">pre-release area</a> and filling out a bug report.
		Tester understands that prompt and accurate reports are of great value to NetworkDLS, and promises best efforts to provide such reports.
  </BlockQuote>
</P>
<P>
...
<P>
<B>OWNERSHIP OF THE PRODUCT</B><BR>
  <BlockQuote>
...
<P>
<B>TESTER MAY NOT COPY THE PRODUCT; LIMITED LICENSE</B><BR>
  <BlockQuote>
...
<P>
<B>NO OBLIGATION ON BEHALF OF NETWORKDLS ON ACCOUNT OF INFORMATION PROVIDED BY TESTER</B><BR>
  <BlockQuote>
