...
namespace HtmlHelpViewer
{
	...
	public class Viewer : System.Windows.Forms.Form, IHelpViewer
	{
        ...
        public void IndexSelect(string indexText)
        {
            this.helpIndex1.SelectText(indexText);

            //this.helpIndex1.select

            tabControl1.SelectedTab = tabIndex;
        }
        ...
        public string GetRegistryString(string sName, string Default)
        {
            ...
            RegistryKey regSubKey = regKey.OpenSubKey(global.RegistryKey + "\\IDE\\Help");
